...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-md">
      <div className={`rounded-3xl w-full max-w-6xl h-[92vh] flex flex-col shadow-2xl text-right overflow-hidden transition-colors duration-300 border ${
        isLightAdmin 
        ...
        <div className={`p-4 sm:p-6 border-b flex items-center justify-between transition-colors duration-300 ${
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#00A859] text-white flex items-center justify-center font-bold shadow-sm">
              <LayoutDashboard className="w-5 h-5" />
            </div>
            <div>
              <h2 className={`font-['Cairo'] font-extrabold text-lg sm:text-xl ${isLightAdmin ? 'text-slate-900' : 'text-[#FAEDCD]'}`}>
                لوحة التحكم الإدارية (Admin Panel)
              </h2>
              <p className="text-xs text-[#00A859] font-bold">
                إدارة منتجات كورتادو كافيه، الطلبات، العملاء، والإعدادات
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center gap-2 transition-all cursor-pointer border shadow-xs ${
                isLightAdmin
            ...
            >
              {isLightAdmin ? (
                <>
                  <Moon className="w-4 h-4 text-[#00A859]" />
                  <span className="hidden sm:inline">النمط البني 🌙</span>
                </>
              ) : (
                <>
                  <Sun className="w-4 h-4 text-amber-400" />
                  <span className="hidden sm:inline">النمط الأبيض ☀️</span>
                </>
              )}
            </button>
        ...
        {/* TABS NAVIGATION BAR */}
        <div className={`border-b px-4 py-2 flex items-center gap-2 overflow-x-auto scrollbar-none transition-colors duration-300 ${
          ...
          >
            ...
            <span>القائمة والمنتجات ({products.length})</span>
          </button>
          ...
          >
            ...
            <span>طلبات المتجر ({orders.length})</span>
          </button>
        ...
        <div className={`flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 transition-colors duration-300 ${
          ...
          {activeAdminTab === 'overview' && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-[#2D2926] p-5 rounded-2xl border border-[#FAEDCD]/10">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs text-[#FAEDCD]/70">إجمالي المبيعات</span>
                    <DollarSign className="w-5 h-5 text-emerald-400" />
                  </div>
                  <span className="font-['Cairo'] font-black text-2xl text-[#FAEDCD]">
                    {totalRevenue.toFixed(2)} <span className="text-xs font-normal">ل.س</span>
                  </span>
                </div>

                <div className="bg-[#2D2926] p-5 rounded-2xl border border-[#FAEDCD]/10">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs text-[#FAEDCD]/70">عدد الطلبات المسجلة</span>
                ...
                <div className="bg-[#2D2926] p-5 rounded-2xl border border-[#FAEDCD]/10">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs text-[#FAEDCD]/70">العملاء المسجلين</span>
                ...
                <div className="bg-[#2D2926] p-5 rounded-2xl border border-[#FAEDCD]/10">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs text-[#FAEDCD]/70">أكواد الخصم المفتوحة</span>
              ...
              <div className="bg-[#2D2926] p-6 rounded-2xl border border-[#FAEDCD]/10">
                <h3 className="font-bold text-base text-[#FAEDCD] mb-4">أحدث الطلبات القادمة</h3>
                  ...
                  <table className="w-full text-right text-xs">
                    <thead>
                      <tr className="border-b border-[#D4A373]/20 text-[#D4A373]">
                        ...
                        <th className="pb-3">نوع الخدمة</th>
                    ...
                    <tbody className="divide-y divide-[#D4A373]/10">
                      {orders.slice(0, 5).map((ord) => (
                        <tr key={ord.id} className="hover:bg-[#1E1B18]/50">
                          <td className="py-3 font-mono font-bold text-[#D4A373]">{ord.id}</td>
                          <td className="py-3 font-bold">{ord.customerName}</td>
                          <td className="py-3">{getStatusBadge(ord.status)}</td>
                          <td className="py-3">{ord.deliveryType === 'table' ? 'طاولة' : ord.deliveryType === 'takeaway' ? 'سفري' : 'توصيل'}</td>
                          <td className="py-3 font-bold">{ord.total.toFixed(2)} ل.س</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <form onSubmit={handleSaveSettings} className="space-y-6 max-w-4xl">
              ...
              <div className="bg-[#2D2926] border border-[#D4A373]/30 p-4 rounded-2xl flex items-start gap-3">
                ...
                <div className="text-xs text-[#FAEDCD]/90 space-y-1">
                  <p className="font-bold text-[#D4A373]">ملاحظات ومواصفات المقاسات الموصى بها:</p>
              ...
              {settingsSavedMsg && (
                <div className="p-3 bg-emerald-950 border border-emerald-500/40 text-emerald-300 rounded-xl text-xs font-bold flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-[#D4A373] mb-1">عنوان الكافيه</label>
                  <input
                    type="text"
                    value={siteTitle}
                    onChange={(e) => setSiteTitle(e.target.value)}
                    className="w-full bg-[#2D2926] border border-[#D4A373]/20 rounded-xl px-4 py-2.5 text-xs text-[#FAEDCD] outline-none"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-[#D4A373] mb-1">الوصف الفرعي</label>
                  <input
                    type="text"
                    value={siteSubtitle}
                ...
                <div className="sm:col-span-2 space-y-2">
                  <label className="block text-xs font-bold text-[#D4A373]">شعار الكافيه (Logo)</label>
                  <div className="flex flex-col sm:flex-row items-center gap-3">
                    {logoUrl && (
                      <div className="w-12 h-12 rounded-xl bg-[#181512] border border-[#D4A373]/30 p-1 flex-shrink-0">
                    ...
                    <input
                      ...
                      placeholder="https://..."
                      className="flex-1 w-full bg-[#2D2926] border border-[#D4A373]/20 rounded-xl px-4 py-2.5 text-xs text-[#FAEDCD] outline-none font-mono"
                    />
                    <label className="bg-[#00A859] hover:bg-[#008A48] text-white text-xs font-bold px-4 py-2.5 rounded-xl flex items-center gap-1.5 cursor-pointer transition-all flex-shrink-0 self-stretch sm:self-auto justify-center">
                ...
                <div>
                  <label className="block text-xs font-bold text-[#D4A373] mb-1">رقم الهاتف والتواصل</label>
                  <input
                    type="text"
                    value={phone}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#D4A373] mb-1">عنوان الموقع الرئيسي الفرعي</label>
                  <input
                    type="text"
                    value={address}
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-bold text-[#D4A373] mb-1 flex items-center gap-1.5">
          ...
          {activeAdminTab === 'products' && (
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <h3 className="font-bold text-base text-[#FAEDCD]">قائمة المنتجات والأصناف</h3>
                  <p className="text-xs text-[#FAEDCD]/60">موزعة حسب الأقسام (باردة، ساخنة، حلويات، خلطات)</p>
                </div>
                <div className="flex flex-wrap items-center gap-2 self-stretch sm:self-auto">
                  <button
                    onClick={() => setShowCategoryModal(true)}
                    className="bg-[#2D2926] hover:bg-[#322A23] text-[#00A859] border border-[#00A859]/40 font-bold text-xs px-3.5 py-2.5 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer shadow-md transition-all active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="bg-[#D4A373] text-[#181512] hover:bg-[#c39262] font-bold text-xs px-3.5 py-2.5 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer shadow-md transition-all active:scale-95"
                  >
                    <UploadCloud className="w-4 h-4" />
                    <span>رفع دفعة صور منتجات</span>
                  </button>

                  <button
                    onClick={handleOpenAddProduct}
                    className="bg-[#00A859] hover:bg-[#008A48] text-white font-bold text-xs px-4 py-2.5 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer shadow-md transition-all active:scale-95"
                  >
                    <Plus className="w-4 h-4" />
                  ...
                  <button
                    ...
                    className="bg-[#2D2926] hover:bg-rose-900/40 text-rose-300 border border-rose-500/30 font-bold text-xs px-3 py-2.5 rounded-xl flex items-center justify-center gap-1 cursor-pointer transition-all active:scale-95"
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-3 bg-[#26201B] p-3 rounded-2xl border border-[#3D332A]">
                  ...
                  {categories.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {cat.isHidden && <span className="text-[10px] text-rose-300">(مخفي)</span>}
                ...
                <div className="w-full md:w-64">
                  <input
                    ...
                    className="w-full bg-[#1E1B18] border border-[#3D332A] rounded-xl px-3 py-1.5 text-xs text-[#FAEDCD] outline-none"
                  />
                </div>
              </div>
          ...
          {activeAdminTab === 'customers' && (
            <div className="space-y-4">
              <h3 className="font-bold text-base text-[#FAEDCD]">قائمة العملاء المسجلين</h3>
              <div className="overflow-x-auto bg-[#221C17] rounded-2xl border border-[#2D2721] p-4">
                <table className="w-full text-right text-xs">
                  <thead>
                      ...
                      <tr key={c.uid}>
                        <td className="py-3 flex items-center gap-2">
                          {c.photoURL ? (
                            ...
                            <div className="w-7 h-7 rounded-full bg-[#D4A373] text-[#181512] flex items-center justify-center font-bold">
                              {c.name.charAt(0)}
                            </div>
                          )}
                        ...
                        <td className="py-3">{c.joinedAt}</td>
                        <td className="py-3 font-bold text-[#D4A373]">{c.totalOrdersCount || 1} طلبات</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-[#26201B] p-4 rounded-2xl border border-[#3D332A]">
                ...
                <div className="flex flex-wrap items-center gap-2 self-stretch sm:self-auto">
                  ...
                  <button
                    ...
                    className="bg-[#10B981] hover:bg-[#059669] text-white font-extrabold text-xs px-3.5 py-2.5 rounded-xl flex items-center justify-center gap-1.5 shadow-md cursor-pointer transition-all active:scale-95"
                  ...
                  <button
                    ...
                    className="bg-[#00A859] hover:bg-[#008A48] text-white font-extrabold text-xs px-3.5 py-2.5 rounded-xl flex items-center justify-center gap-1.5 shadow-md cursor-pointer transition-all active:scale-95"
                    title="توليد 100+ كود خصم لمدرسة أو جامعة أو جهة معينة"
                  >
                    <Zap className="w-4 h-4 text-amber-300 fill-amber-300 animate-pulse" />
                    <span>توليد أكواد بالجملة (100+) ⚡</span>
                  </button>
                  ...
                  <button
                    ...
                    className="bg-[#2D2926] hover:bg-[#322A23] text-[#FAEDCD] border border-[#3D332A] font-bold text-xs px-3 py-2.5 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer transition-all active:scale-95"
                  >
                    <Sparkles className="w-4 h-4 text-[#00A859]" />
                    <span>كود واحد تلقائي</span>
                  </button>
                  ...
                  <button
                    ...
                    className="bg-[#D4A373] text-[#181512] hover:bg-[#c39262] font-bold text-xs px-3 py-2.5 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer transition-all active:scale-95"
                  >
                    <Plus className="w-4 h-4" />
                    <span>إنشاء كود يدوي</span>
                  </button>
                </div>
              </div>
